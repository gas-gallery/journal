...
const isGASEnvironment = typeof google !== 'undefined' && (google as any).script;
...
export const API = {
  getInboxTasks: () => 
    callGASFunction<APIResponse<InboxTask[]>>('getInboxTasks'),
  
  createInboxTask: (name: string) => 
    callGASFunction<APIResponse<InboxTask>>('createInboxTask', name),
